...
void bench_context_verify(void* arg) {
    ...
    (void)arg;
    for (i = 0; i < 20; i++) {
        ela_secp256k1_context_destroy(ela_secp256k1_context_create(SECP256K1_CONTEXT_VERIFY));
    }
}
...
void bench_context_sign(void* arg) {
    ...
    (void)arg;
    for (i = 0; i < 200; i++) {
        ela_secp256k1_context_destroy(ela_secp256k1_context_create(SECP256K1_CONTEXT_SIGN));
    }
}
